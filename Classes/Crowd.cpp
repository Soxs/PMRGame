...
void Crowd::update(float delta) {
	...
	if (GameWorld::instance->tileCoordForPosition(location).distance(GameWorld::instance->tileCoordForPosition(GameWorld::instance->player->actualPosition) ) == 0
		)
	{

		float a = GameWorld::instance->tileCoordForPosition(location).distance(GameWorld::instance->tileCoordForPosition(GameWorld::instance->player->actualPosition));
		isAlive = false;
