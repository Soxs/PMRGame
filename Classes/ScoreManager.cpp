...
void ScoreManager::addToScore(int toadd, cocos2d::Vec2 loc) {
    ...
    Sequence* anim = cocos2d::Sequence::create(cocos2d::MoveTo::create(1.0f, Vec2(loc.x, loc.y + 50)), cocos2d::DelayTime::create(1.0f), cocos2d::MoveTo::create(0.5f, gameInstance->convertToNodeSpace(CCDirector::sharedDirector()->convertToGL(Vec2(110, 130)))), cocos2d::RemoveSelf::create(), NULL);
